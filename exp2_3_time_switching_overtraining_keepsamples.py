...
#    options = {'balancing_tf': '', 'balancing': 'nnload', 'walking': 'nnload_rbload'}
    ...
    options = {'balancing_tf': '', 'balancing': 'nnload_rbload', 'walking': 'nnload'}
...
#    mp_cfgs += do_reach_timeout_based(args, cores, name='ddpg-exp2_3-three_stage-rb5', reach_timeout=(5.0, 5.0, 0.0), options=options, **misc)
#    mp_cfgs += do_reach_timeout_based(args, cores, name='ddpg-exp2_3-two_stage-rb5', reach_timeout=(-1.0, 5.0, 0.0), options=options, **misc)

#    mp_cfgs += do_reach_timeout_based(args, cores, name='ddpg-exp2_3-three_stage-rb20', reach_timeout=(20.0, 20.0, 0.0), options=options, **misc)
#    mp_cfgs += do_reach_timeout_based(args, cores, name='ddpg-exp2_3-two_stage-rb20', reach_timeout=(-1.0, 20.0, 0.0), options=options, **misc)
    ...
    mp_cfgs += do_reach_timeout_based(args, cores, name='ddpg-exp2_3-three_stage-rb55', reach_timeout=(5.0, 5.0, 0.0), options=options, **misc)
#    mp_cfgs += do_reach_timeout_based(args, cores, name='ddpg-exp2_3-two_stage-rb55', reach_timeout=(-1.0, 5.0, 0.0), options=options, **misc)

#    mp_cfgs += do_reach_timeout_based(args, cores, name='ddpg-exp2_3-three_stage-rb2020', reach_timeout=(20.0, 20.0, 0.0), options=options, **misc)
#    mp_cfgs += do_reach_timeout_based(args, cores, name='ddpg-exp2_3-two_stage-rb2020', reach_timeout=(-1.0, 20.0, 0.0), options=options, **misc)
